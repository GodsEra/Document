...
### 2019.7.11
>* [商品详情](#商品详情) 添加 是否已操作常购清单状态：是-joined 否-not_joined
>* 增加 [操作常购清单](#操作常购清单) [已加入的常购清单列表](#已加入的常购清单列表)  
            ...
            "spec_list": [                  【规格列表】
                {
                    ...
                    "type": "std",                      【规格类型：标准的-std，预订的-advance】
                    "min_buy_number": 1,         【起售数】
                    "join_status": "joined"         【是否已操作常购清单状态：是-joined 否-not_joined】
                },
                {
                    "id": 11,
                    "price": "2.00",
